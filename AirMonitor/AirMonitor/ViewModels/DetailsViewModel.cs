...
namespace AirMonitor.ViewModels
{
    public class DetailsViewModel : INotifyPropertyChanged
    {
        ...
        private string _caqiDescription = "Możesz bezpiecznie wyjść z domu bez swojej maski antysmogowej i nie bać się o swoje zdrowie.";
